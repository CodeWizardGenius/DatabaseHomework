...
public class DeleteCustomerPage extends javax.swing.JFrame {
    ...
    if(this.checkInput()){
            this.customer = this.db.getCustomer(this.searchMailTF.getText());
            if(this.customer != null){
                String answer = JOptionPane.showInputDialog(this, AppInfo.DOUBLE_CHECK_MESSAGE, AppInfo.APP_NAME, 3);
                if(answer.toLowerCase().equals("yes")){
                    this.db.deleteAddress(this.customer.getAdress().getId());
                    this.db.deleteUser(this.customer.getEmail());
                    this.db.deleteCustomer(this.customer.getEmail());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteCustomerPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void initalSettings() {
        ...
        this.setTitle(AppInfo.APP_NAME + " - " + AppInfo.DELETE_CUSTOMER_PAGE);
